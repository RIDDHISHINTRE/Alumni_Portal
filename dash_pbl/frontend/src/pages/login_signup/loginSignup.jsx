    ...
    >
      ...
      <div className="hidden md:flex w-1/2  bg-opacity-60 text-white items-center justify-center px-8">
        <div className="text-center">
          <h2 className="text-3xl font-semibold mb-2">Alumni Connect</h2>
        ...
        <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-8 sm:p-10 font-poppins">
          ...
          {islogin ? (
            <form className="flex flex-col gap-4" onSubmit={handleLogin}>
              ...
              <div>
                <Link to="/forgot-password" className="text-blue-700 hover:text-blue-900 transition">Forgot Password?</Link>
              </div>
            </form>
          ) : signupstate === "" ? (
            <>
